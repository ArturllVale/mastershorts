    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="relative card p-6 flex flex-col">
          <h3 className="font-display text-xl text-text-primary capitalize">Free</h3>
          <p className="text-text-secondary text-sm mb-4">Try it on your own videos</p>
          <div className="mb-4 flex items-baseline gap-1.5">
            <span className="font-display text-4xl text-text-primary tabular-nums">$0</span>
            <span className="font-mono text-xs text-text-tertiary">/mo</span>
          </div>
          <ul className="space-y-2.5 text-sm text-text-secondary mb-6 flex-1">
            <li className="flex items-start gap-2"><Check size={16} className="text-success shrink-0 mt-0.5" /> <span><b>{FREE_MINUTES} min</b> of video / month</span></li>
            <li className="flex items-start gap-2"><Check size={16} className="text-success shrink-0 mt-0.5" /> <span>YouTube URL or upload</span></li>
            <li className="flex items-start gap-2"><Cpu size={16} className="text-success shrink-0 mt-0.5" /> <span>Same <b>GPU rendering</b>, ~50s per 8-min video</span></li>
            <li className="flex items-start gap-2"><KeyRound size={16} className="text-success shrink-0 mt-0.5" /> <span>Gemini key included, no setup</span></li>
            <li className="flex items-start gap-2"><Check size={16} className="text-success shrink-0 mt-0.5" /> <span>No credit card — Google sign-in</span></li>
            <li className="flex items-start gap-2"><Check size={16} className="text-text-tertiary shrink-0 mt-0.5" /> <span className="text-text-tertiary">Watermark · clips kept 7 days</span></li>
          </ul>
          <button
          ...
          <p className="text-center text-xs text-text-tertiary mt-2">Free minutes reset monthly.</p>
        </div>
          ...
          return (
            ...
            >
              ...
              <div className="mb-4 flex items-baseline gap-1.5">
                ...
                <span className="font-mono text-xs text-text-tertiary">/{interval === 'month' ? 'mo' : 'yr'}</span>
              </div>
              <ul className="space-y-2.5 text-sm text-text-secondary mb-6 flex-1">
                <li className="flex items-start gap-2"><Check size={16} className="text-success shrink-0 mt-0.5" /> <span><b>{entry.minutes} min</b> of video / month</span></li>
                <li className="flex items-start gap-2"><Check size={16} className="text-success shrink-0 mt-0.5" /> <span><b>No watermark</b>, no 7-day clip expiry</span></li>
                <li className="flex items-start gap-2"><Cpu size={16} className="text-success shrink-0 mt-0.5" /> <span><b>GPU rendering</b>, ~50s per 8-min video</span></li>
                <li className="flex items-start gap-2"><KeyRound size={16} className="text-success shrink-0 mt-0.5" /> <span>Gemini key + auto-posting included</span></li>
                <li className="flex items-start gap-2"><Bot size={16} className="text-success shrink-0 mt-0.5" /> <span><b>MCP + API access</b> for automations</span></li>
                {plan === 'pro' && <li className="flex items-start gap-2"><Zap size={16} className="text-accent shrink-0 mt-0.5" /> <span>Priority processing queue</span></li>}
              </ul>
              <button
              ...
              >
                {busyPrice === entry.price_id ? <Loader2 size={18} className="animate-spin" /> : `Get ${plan.charAt(0).toUpperCase() + plan.slice(1)}`}
              </button>
              <p className="text-center text-xs text-text-tertiary mt-2">Billed {interval === 'month' ? 'monthly' : 'yearly'}. Cancel anytime.</p>
            </div>
          );
        })}
      </div>
      ...
      <div className="mt-10 grid md:grid-cols-2 gap-4">
        ...
        <div className="card p-6">
          ...
          <p className="text-sm text-muted mb-3 leading-relaxed">
            Advanced features like <b className="text-ink2">voice dubbing</b> use external AI models.
            Connect your own keys for those — you are billed by those providers directly. Your plan still covers video clipping and orchestration.
          </p>
