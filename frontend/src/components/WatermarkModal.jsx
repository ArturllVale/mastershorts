...
export default function WatermarkModal({ onClose, onContinue }) {
  ...
  return (
    <Modal isOpen onClose={() => close(false)} eyebrow="PLANO GRATUITO" title="Remover marca d'água" size="md">
      <p className="text-muted text-sm mb-4">
        Clipes no plano gratuito contêm a marca d'água do MasterShorts no canto e ficam salvos por 7 dias. Os planos premium exportam clipes 100% limpos e de alta definição.
      </p>
