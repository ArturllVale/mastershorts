...
_FORWARD_HEADERS = (
    "authorization", "x-api-key", "x-gemini-key", "x-upload-post-key",
    "x-llm-provider", "x-openrouter-key", "x-mistral-key",
    "x-llm-base-url", "x-llm-model", "x-llm-api-key", "x-llm-fallback-models"
)
